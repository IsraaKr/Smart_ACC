...
namespace Smart_ACC_DataBase
{
    ...
    public partial class T_INVOICE_SALES_ITEM_BACK
    {
        public decimal sal_inv_item_b_id { get; set; }
        public Nullable<decimal> sal_inv_item_b_code { get; set; }
        public Nullable<System.DateTime> sal_inv_item_b_date { get; set; }
        public Nullable<System.TimeSpan> sal_inv_item_b_time { get; set; }
        public string sal_inv_item_b_text { get; set; }
        ...
        public Nullable<decimal> sal_inv_b_id { get; set; }
