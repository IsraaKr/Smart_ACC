...
namespace Smart_ACC_DataBase
{
    ...
    public partial class T_INVOICE_SALES_BONES
    {
        public decimal sal_inv_bon_id { get; set; }
        public Nullable<decimal> sal_inv_bon_code { get; set; }
        public Nullable<System.DateTime> sal_inv_bon_date { get; set; }
        public Nullable<System.TimeSpan> sal_inv_bon_time { get; set; }
        public string sal_inv_bon_text { get; set; }
        public Nullable<int> count { get; set; }
        public Nullable<bool> sal_inv_bon_stae { get; set; }
        public string sal_inv_bon_note { get; set; }
